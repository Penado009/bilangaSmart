    ...
    close_cart.addEventListener('click', () =>{
     ...
     window.addEventListener('resize', () => {
        ...
        if (window.innerWidth > 768) {
            // opcional: adicione lógica de redimensionamento aqui
        }
     })
     ...
     if (typeof Chart !== 'undefined') {
        const graficDiario = document.getElementById('graficDiario')
        if (graficDiario) {
            new Chart(graficDiario, {
                type: 'line',
                data: {
        ...
        const graficMensal = document.getElementById('graficMensal')
        if (graficMensal) {
            new Chart(graficMensal, {
                type: 'bar',
                data: {
        ...
        const graficVendido = document.getElementById('graficVendido')
        if (graficVendido) {
            new Chart(graficVendido, {
                type: 'doughnut',
                data: {
